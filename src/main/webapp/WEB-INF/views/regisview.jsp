...
<div class="panel pannel-default">
	<div class="panel-header" align="center">Registration Form</div>
	<div class="panel-body">
		...
		<form:form action="${req}/visitor/save" method="post" modelAttribute="vis">
			<table border="1" width="600" align="center">
				...
				<tr align="center">
					<td align="center"><input type="submit" value="Save" class="btn btn-sm btn-primary"/>
					<a href="${req}/payment" class="btn btn-info" role="button">Payment</a> 
					<a href="${req}/" class="btn btn-info" role="button">Home</a>
					</td>
